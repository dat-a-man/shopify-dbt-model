...
FROM  {{ ref('stg_orders__line_items') }} as orders__line_items
LEFT JOIN {{ ref('dim_products') }} as products__product_id ON
        products__product_id.id = orders__line_items.product_id

LEFT JOIN {{ ref('dim_products__variants') }} as products__variants__variant_id ON
        products__variants__variant_id.id = orders__line_items.variant_id

LEFT JOIN {{ ref('dim_products') }} as products__product_id__products__variants__variant_id ON
        products__product_id__products__variants__variant_id.id = products__variants__variant_id.product_id

LEFT JOIN {{ ref('dim_products') }} as products__products__variants__variant_id ON
        products__products__variants__variant_id._dlt_id = products__variants__variant_id._dlt_parent_id

LEFT JOIN {{ ref('fact_orders') }} as orders ON
